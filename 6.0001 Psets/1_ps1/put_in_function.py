...
def put_in_functions_a():
    ...
    FUNCTION_HEADER = 'def %s(salary, savings_percent, total_cost):' % (FUNCTION_NAME)
...
def put_in_functions_b():
    ...
    FUNCTION_HEADER = 'def %s(salary, savings_percent, total_cost, raise_percentage):' % (FUNCTION_NAME)
...
def put_in_functions_c():
    ...
    FUNCTION_HEADER = 'def %s(starting_amount):' % (FUNCTION_NAME)
